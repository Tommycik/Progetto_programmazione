...
public:
    ...
    bool checker(Spawner &creator, Mario &hero, bool &itemText, bool &safezoneText, bool &teleportText,
    ...
    void show(sf::RenderWindow &window, sf::View &view1, bool &makeText, bool &itemText, bool &tutorialItem,
              bool &safezoneText, bool &tutorialSafezone, bool &teleportText, bool &tutorialTeleport);
